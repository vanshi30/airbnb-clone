    ...
    <>
      <div className="flex gap-2">
        ...
        <button
          ...
          className="bg-gray-200 px-4 rounded-2xl hover:text-primary shadow-xl"
        >
          ADD&nbsp;photo
        </button>
      </div>
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6 p-8 text-2xl text-gray-600">
        ...
        <label className="h-32 cursor-pointer flex gap-1 items-center justify-center border bg-transparent rounded-2xl p-2 text-2xl text-gray=600 hover:shadow-lg">
          <input
            type="file"
            multiple
            className="hidden"
